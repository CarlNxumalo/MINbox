<script>
    ...
    import { Search, Button, Select, Card } from 'flowbite-svelte';
...
<Section name="contact">
    ...
    <Card class="w-full max-w-3xl mt-2" style="box-sizing: border-box; width: 100%; padding:1rem" href="http://localhost:5173/lecturer/email/{m.id}"  data-sveltekit-preload-data>
